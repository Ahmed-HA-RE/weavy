...
type PasswordVerificationFormProps = EnableTwoFactor | DisableTwoFactor;
      ...
      <FieldGroup className='gap-6'>
        {mode === 'enable' && (
          <FieldSet className='items-center text-center'>
            <FieldLegend className='data-[variant=legend]:text-base'>
              Verify Your Identity
            </FieldLegend>
            <FieldDescription>
              Enter your password to confirm it&apos;s you before enabling 2FA.
            </FieldDescription>
          </FieldSet>
        )}
        <Controller

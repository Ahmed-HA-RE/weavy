  ...
  <Tailwind config={{ presets: [pixelBasedPreset] }}>
    <Html>
      ...
      <Body className='m-0 text-center'>
        <Preview>
          You requested to permanently delete your account. Click the link below to confirm this action.
        </Preview>
            ...
            <Section className='mobile:px-2 px-6 py-4'>
              <Section className='bg-gray-50 px-6 py-12 rounded-[8px] md:px-[40px] md:py-[64px] text-center'>
                ...
                <Text className={sharedTextClasses}>
                  We are sorry to see you go! Please confirm that you want to delete your account by clicking the button
                  below.
                </Text>

                <Section className='mb-6 text-center'>
                  <Button href={url} className='bg-red-500 inline-block py-4 px-7 rounded-lg text-white text-base'>
